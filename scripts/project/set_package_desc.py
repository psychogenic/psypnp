'''
Set the (nv-stored) location for the "package description" CSV 
...
def set_file_location():
    ...
    if fdefault is None:
        ...
        if fdefault is None:
            fdefault = 'data/package_desc.csv'
            
            
    flocation = psypnp.ui.getUserInput("Relative location for package desc CSV", fdefault)
    ...
    psypnp.ui.showMessage("OK, package desc at %s " % flocation)
    return False 
